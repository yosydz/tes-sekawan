                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col text-right">
                                <a href="{{ route('kendaraan.create') }}" class="btn btn-sm btn-primary">Tambah Data Kendaraan</a>
                            </div>
                        </div>
                    </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="dropdown-item"
                                                            href="{{ route('kendaraan.edit', $k->id) }}">Edit</a>
                                                        <form class="d-inline" method="POST" action="{{ route('kendaraan.destroy', $k->id) }}">
                                                            @csrf
                                                            @method('DELETE')
